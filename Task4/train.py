...
from data_helper import dataset2dataloader
from model import BiLSTM_CRF_NER
...
if __name__ == "__main__":
    ...
    model = BiLSTM_CRF_NER(vocab_size=len(sent_vocab.stoi), embedding_dim=50, hidden_size=128,
                           num_tags=len(tag_vocab.stoi), word_vectors=word_vectors, device=device)
